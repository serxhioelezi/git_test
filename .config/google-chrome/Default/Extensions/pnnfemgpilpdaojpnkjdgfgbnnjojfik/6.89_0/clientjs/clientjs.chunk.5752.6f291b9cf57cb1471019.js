"use strict";
export const id = 5752;
export const ids = [5752,7341];
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   F: () => (/* binding */ SETTING)
/* harmony export */ });
const SETTING = 'sequencesViewRoute';
...
/* harmony import */ var _services_locale_locale__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(35091);
/* harmony import */ var _widgets_react_material_icon_icon__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(84347);
/* harmony import */ var _services_tracker_tracker__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(13778);
/* harmony import */ var _sequenceManager__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(28778);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(44345);
/* harmony import */ var _streakyc_images_email_all_default_png__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(39813);
/* harmony import */ var _streakyc_images_email_all_vivid_png__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(58128);
/* harmony import */ var _streakyc_images_email_all_white_png__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(29612);
/* harmony import */ var _services_localSettings_localSettings__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(55868);
/* harmony import */ var _lib_utils_setURL__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(47107);
/* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(63070);
/* harmony import */ var _leftLink_navMenuController__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(47341);
/* harmony import */ var _leftLink_navMenuController_module_css__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(74875);
/* harmony import */ var _core_routing__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(58556);
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(59718);
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([_sequenceManager__WEBPACK_IMPORTED_MODULE_7__, _leftLink_navMenuController__WEBPACK_IMPORTED_MODULE_14__]);
([_sequenceManager__WEBPACK_IMPORTED_MODULE_7__, _leftLink_navMenuController__WEBPACK_IMPORTED_MODULE_14__] = __webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__);
...
const trackingPrefix = 'appMenu.';
const _SequencesView = /*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_8__.lazy)(() => __webpack_require__.e(/* import() */ 7397).then(__webpack_require__.bind(__webpack_require__, 47397)));
const SequencesView = () => /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsx)(react__WEBPACK_IMPORTED_MODULE_8__.Suspense, {
  fallback: null,
  children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsx)(_SequencesView, {})
});
const SequenceView = /*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_8__.lazy)(() => __webpack_require__.e(/* import() */ 4176).then(__webpack_require__.bind(__webpack_require__, 34176)));
_lib_dependencyManager__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .ZP.addFunction({
  dependentFunctionKeys: ['sequenceManagerInitialized', 'userPreServerExperiment', 'userLoggedIn', 'userSettingsInitialized', 'enabledFeaturesControllerInitialized', 'navMenuInitialized'],
  functionKey: 'sequenceViewMasterControllerInitialized',
  functionReference: async () => {
    _handleCustomRoute();
    if (_leftLink_navMenuController__WEBPACK_IMPORTED_MODULE_14__.navMenuController.streakPanelView) {
      _leftLink_navMenuController__WEBPACK_IMPORTED_MODULE_14__.navMenuController.streakPanelView.addNavItem({
        name: _services_locale_locale__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .Z.getString('streak_sequences'),
        iconClass: _leftLink_navMenuController_module_css__WEBPACK_IMPORTED_MODULE_17__/* .navItemIcon */ .U,
        iconLiga: 'stacked_email',
        routeID: _core_routing__WEBPACK_IMPORTED_MODULE_15__/* .StreakCustomRoute */ .ld.SEQUENCES_ALL,
        orderHint: 3
      });
    } else {
      await _createNavItems();
    }
  }
});

/** Frustratingly, all permutations of options AREN'T available for various icons/colors. */
const themedMaterialIconUrl = _ref => {
  let {
    icon,
    color,
    scaling = 2,
...
function newMailMerge(variant) {
  return async function () {
    _services_tracker_tracker__WEBPACK_IMPORTED_MODULE_6__["default"].track(`createNewSequence.${variant}`);
    _sequenceManager__WEBPACK_IMPORTED_MODULE_7__["default"].showChooseDataSourceInNextCompose();
    await _streakyc_common_core_gmail_inboxSdkSingleton__WEBPACK_IMPORTED_MODULE_0__.inboxSDK.Compose.openNewComposeView();
  };
}
async function setUpAppMenuItem() {
  const mmAppMenu = _streakyc_common_core_gmail_inboxSdkSingleton__WEBPACK_IMPORTED_MODULE_0__.inboxSDK.AppMenu.addMenuItem({
    name: _services_locale_locale__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .Z.getString('streak_sequences_abbr'),
    onClick: () => {
      _services_tracker_tracker__WEBPACK_IMPORTED_MODULE_6__["default"].track(trackingPrefix + "mm.appMenuItemClick");
      if (!location.hash.startsWith('#sequence')) {
        _streakyc_common_core_gmail_inboxSdkSingleton__WEBPACK_IMPORTED_MODULE_0__.inboxSDK?.Router.goto(_core_routing__WEBPACK_IMPORTED_MODULE_15__/* .StreakCustomRoute */ .ld.SEQUENCES_LATEST);
      }
    },
    iconUrl: {
      lightTheme: {
        default: _streakyc_images_email_all_default_png__WEBPACK_IMPORTED_MODULE_9__,
        active: _streakyc_images_email_all_vivid_png__WEBPACK_IMPORTED_MODULE_10__
      },
      darkTheme: {
        default: _streakyc_images_email_all_white_png__WEBPACK_IMPORTED_MODULE_11__,
        active: _streakyc_images_email_all_vivid_png__WEBPACK_IMPORTED_MODULE_10__
      }
    },
    insertIndex: 2,
    isRouteActive: routeView => {
      const routeViewID = routeView.getRouteID();
      return routeViewID?.startsWith('sequence') ?? false;
    }
  });
  const panel = await mmAppMenu.addCollapsiblePanel({
    primaryButton: {
      name: _services_locale_locale__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .Z.getString('new_mailmerge'),
      onClick: () => {
        newMailMerge('clickAppPanel')();
        _services_tracker_tracker__WEBPACK_IMPORTED_MODULE_6__["default"].track(trackingPrefix + "mm.primaryButtonClick");
      },
      iconUrl: {
...
async function setUpMailMergeNavItem() {
  const isAppMenuShown = await _streakyc_common_core_gmail_inboxSdkSingleton__WEBPACK_IMPORTED_MODULE_0__.inboxSDK.AppMenu.isShown();
  if (isAppMenuShown) {
  ...
  const navItemDescriptor = {
    name: _services_locale_locale__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .Z.getString('streak_sequences'),
    iconClass: 'sequencesIndicator',
    accessory: {
      type: 'CREATE',
      onClick: newMailMerge('click')
    }
  };
  return _streakyc_common_core_gmail_inboxSdkSingleton__WEBPACK_IMPORTED_MODULE_0__.inboxSDK.NavMenu.addNavItem(navItemDescriptor);
}
async function _createNavItems() {
  const sequencesNavItem = await setUpMailMergeNavItem();
  [{
    iconName: 'all_inbox',
    name: _services_locale_locale__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .Z.getString('all'),
    routeId: 'all'
  }, {
    iconName: 'play_circle_outline',
    name: _services_locale_locale__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .Z.getString('active'),
    routeId: 'active'
  }, {
    iconName: 'insert_drive_file',
    name: _services_locale_locale__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .Z.getString('draft'),
    routeId: 'draft'
  }].forEach(_ref2 => {
    let {
      iconName,
    ...
    (0,_core_appShell__WEBPACK_IMPORTED_MODULE_2__/* .renderWithAppShell */ .oC)(/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsx)(_widgets_react_material_icon_icon__WEBPACK_IMPORTED_MODULE_5__/* ["default"] */ .Z, {
      className: "streak__navMenu_pipelineIcon",
      isOutline: true,
      materialIconName: iconName,
      mini: true
    }), iconElement);
    const childNavItem = sequencesNavItem?.addNavItem({
      iconElement,
      name,
      routeID: `sequences/${routeId}`
    });
...
function _handleCustomRoute() {
  for (const route of [_core_routing__WEBPACK_IMPORTED_MODULE_15__/* .StreakCustomRoute */ .ld.SEQUENCES_ALL, _core_routing__WEBPACK_IMPORTED_MODULE_15__/* .StreakCustomRoute */ .ld.SEQUENCES_ACTIVE, _core_routing__WEBPACK_IMPORTED_MODULE_15__/* .StreakCustomRoute */ .ld.SEQUENCES_DRAFT]) {
    _streakyc_common_core_gmail_inboxSdkSingleton__WEBPACK_IMPORTED_MODULE_0__.inboxSDK.Router.handleCustomRoute(route, customRouteView => {
      _services_localSettings_localSettings__WEBPACK_IMPORTED_MODULE_12__.InMemorySettings.set(_constants__WEBPACK_IMPORTED_MODULE_18__/* .SETTING */ .F, route);
      (0,_core_appShell__WEBPACK_IMPORTED_MODULE_2__/* .renderWithAppShell */ .oC)(/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsx)(SequencesView, {}), customRouteView.getElement());
      customRouteView.on('destroy', () => {
        react_dom__WEBPACK_IMPORTED_MODULE_1__.unmountComponentAtNode(customRouteView.getElement());
      });
    });
  }
  _streakyc_common_core_gmail_inboxSdkSingleton__WEBPACK_IMPORTED_MODULE_0__.inboxSDK.Router.handleCustomRoute(_core_routing__WEBPACK_IMPORTED_MODULE_15__/* .StreakCustomRoute */ .ld.SEQUENCES_LATEST, _ => {
    const newLink = _services_localSettings_localSettings__WEBPACK_IMPORTED_MODULE_12__.InMemorySettings.get(_constants__WEBPACK_IMPORTED_MODULE_18__/* .SETTING */ .F);
    if (newLink) {
      (0,_lib_utils_setURL__WEBPACK_IMPORTED_MODULE_13__/* .replaceHash */ .t)(newLink);
    } else {
      (0,_lib_utils_setURL__WEBPACK_IMPORTED_MODULE_13__/* .replaceHash */ .t)(_core_routing__WEBPACK_IMPORTED_MODULE_15__/* .StreakCustomRoute */ .ld.SEQUENCES_ALL);
      _services_localSettings_localSettings__WEBPACK_IMPORTED_MODULE_12__.InMemorySettings.remove(_constants__WEBPACK_IMPORTED_MODULE_18__/* .SETTING */ .F);
    }
  });
  _streakyc_common_core_gmail_inboxSdkSingleton__WEBPACK_IMPORTED_MODULE_0__.inboxSDK.Router.handleCustomRoute(_core_routing__WEBPACK_IMPORTED_MODULE_15__/* .StreakCustomRoute */ .ld.SEQUENCE, customRouteView => {
    const params = customRouteView.getParams();
    const sequenceKey = params.key;
    if (sequenceKey) {
      _services_localSettings_localSettings__WEBPACK_IMPORTED_MODULE_12__.InMemorySettings.set(_constants__WEBPACK_IMPORTED_MODULE_18__/* .SETTING */ .F, `sequence/${sequenceKey}`);
    }
    (0,_core_appShell__WEBPACK_IMPORTED_MODULE_2__/* .renderWithAppShell */ .oC)(/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsx)(react__WEBPACK_IMPORTED_MODULE_8__.Suspense, {
      fallback: null,
      children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsx)(SequenceView, {
  ...
  _streakyc_common_core_gmail_inboxSdkSingleton__WEBPACK_IMPORTED_MODULE_0__.inboxSDK.Router.handleCustomRoute(_core_routing__WEBPACK_IMPORTED_MODULE_15__/* .StreakCustomRoute */ .ld.SEQUENCE_RECIPIENT_EMAILS, customRouteView => {
    const params = customRouteView.getParams();
    const sequenceKey = params.key;
    const emails = decodeURIComponent(params.emails).split(',');
    if (sequenceKey) {
      _services_localSettings_localSettings__WEBPACK_IMPORTED_MODULE_12__.InMemorySettings.set(_constants__WEBPACK_IMPORTED_MODULE_18__/* .SETTING */ .F, `sequence/${sequenceKey}`);
    }
    (0,_core_appShell__WEBPACK_IMPORTED_MODULE_2__/* .renderWithAppShell */ .oC)(/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsx)(react__WEBPACK_IMPORTED_MODULE_8__.Suspense, {
...
module.exports = __webpack_require__.p + "email-all-default.e99a41ee50a05e6df314.png";
...
module.exports = __webpack_require__.p + "email-all-vivid.9fe5185fb7ef34c96568.png";
...
module.exports = __webpack_require__.p + "email-all-white.dbc3496f6bf838aee98b.png";
...
;
//# sourceMappingURL=https://storage.googleapis.com/streak-extension-sourcemaps/clientjs/clientjs.chunk.5752.6f291b9cf57cb1471019.js.map