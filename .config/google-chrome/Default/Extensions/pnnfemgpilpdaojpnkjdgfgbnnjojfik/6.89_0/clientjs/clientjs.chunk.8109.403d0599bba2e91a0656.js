"use strict";
export const id = 8109;
export const ids = [8109,7341];
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   MJ: () => (/* binding */ CONTACTS_AS_PAID_FEATURE_KEY),
/* harmony export */   MQ: () => (/* binding */ CONTACTS_PERMISSION_ADMIN_KEY),
/* harmony export */   O2: () => (/* binding */ CONTACTS_TEAM_PERMISSION_KEY),
/* harmony export */   QR: () => (/* binding */ CONTACTS_CACHE_KEY_PATTERN),
/* harmony export */   U6: () => (/* binding */ CONTACTS_SELECTED_TEAM_CACHE_KEY),
/* harmony export */   X$: () => (/* binding */ CONTACTS_PERMISSION_NO_ACCESS_KEY),
/* harmony export */   lT: () => (/* binding */ CONTACTS_SYSTEM_COLUMNS_MAP),
/* harmony export */   sh: () => (/* binding */ CONTACTS_COLUMNS_DEV_ONLY),
/* harmony export */   wD: () => (/* binding */ CONTACTS_DEFAULT_PINNED_COLUMNS),
/* harmony export */   yC: () => (/* binding */ CONTACTS_PERMISSION_FULL_ACCESS_KEY)
/* harmony export */ });
/* harmony import */ var _streakyc_ui_components_table__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(16768);

const CONTACTS_SYSTEM_COLUMNS_MAP = {
  name: {
    titleLocaleKey: 'contacts_column_name',
    icon: undefined,
    loadingRenderer: _streakyc_ui_components_table__WEBPACK_IMPORTED_MODULE_0__/* .CIRCLE_PROFILE_LOADING_RENDERER */ .lk.name
  },
  givenName: {
    titleLocaleKey: 'contacts_column_first_name',
    icon: 'notes',
    loadingRenderer: _streakyc_ui_components_table__WEBPACK_IMPORTED_MODULE_0__/* .LOADING_RENDERER */ .qS.name
  },
  familyName: {
    titleLocaleKey: 'contacts_column_last_name',
    icon: 'notes',
    loadingRenderer: _streakyc_ui_components_table__WEBPACK_IMPORTED_MODULE_0__/* .LOADING_RENDERER */ .qS.name
  },
  emailAddresses: {
    titleLocaleKey: 'contacts_column_email',
    icon: 'alternate_email',
    loadingRenderer: _streakyc_ui_components_table__WEBPACK_IMPORTED_MODULE_0__/* .LOADING_RENDERER */ .qS.name
  },
  company: {
    titleLocaleKey: 'contacts_column_company',
    icon: 'domain',
    loadingRenderer: _streakyc_ui_components_table__WEBPACK_IMPORTED_MODULE_0__/* .SQUARE_PROFILE_LOADING_RENDERER */ .wr.name
  },
  pipelines: {
    titleLocaleKey: 'contacts_column_pipelines',
    icon: 'label_important',
    loadingRenderer: _streakyc_ui_components_table__WEBPACK_IMPORTED_MODULE_0__/* .LOADING_RENDERER */ .qS.name
  },
  mailMerges: {
    titleLocaleKey: 'contacts_column_mail_merges',
    icon: 'stacked_email',
    loadingRenderer: _streakyc_ui_components_table__WEBPACK_IMPORTED_MODULE_0__/* .LOADING_RENDERER */ .qS.name
  },
  role: {
    titleLocaleKey: 'contacts_column_role',
    icon: 'badge',
    loadingRenderer: _streakyc_ui_components_table__WEBPACK_IMPORTED_MODULE_0__/* .LOADING_RENDERER */ .qS.name
  },
  phoneNumbers: {
    titleLocaleKey: 'contacts_column_phone',
    icon: 'phone',
    loadingRenderer: _streakyc_ui_components_table__WEBPACK_IMPORTED_MODULE_0__/* .LOADING_RENDERER */ .qS.name
  },
  addresses: {
    titleLocaleKey: 'contacts_column_location',
    icon: 'map',
    loadingRenderer: _streakyc_ui_components_table__WEBPACK_IMPORTED_MODULE_0__/* .LOADING_RENDERER */ .qS.name
  },
  twitter: {
    titleLocaleKey: 'contacts_column_twitter',
    icon: 'twitter',
    loadingRenderer: _streakyc_ui_components_table__WEBPACK_IMPORTED_MODULE_0__/* .LOADING_RENDERER */ .qS.name
  },
  linkedin: {
    titleLocaleKey: 'contacts_column_linkedin',
    icon: 'linkedIn',
    loadingRenderer: _streakyc_ui_components_table__WEBPACK_IMPORTED_MODULE_0__/* .LOADING_RENDERER */ .qS.name
  },
  facebook: {
    titleLocaleKey: 'contacts_column_facebook',
    icon: 'facebook',
    loadingRenderer: _streakyc_ui_components_table__WEBPACK_IMPORTED_MODULE_0__/* .LOADING_RENDERER */ .qS.name
  },
  instagram: {
    titleLocaleKey: 'contacts_column_instagram',
    icon: 'instagram',
    loadingRenderer: _streakyc_ui_components_table__WEBPACK_IMPORTED_MODULE_0__/* .LOADING_RENDERER */ .qS.name
  },
  websites: {
    titleLocaleKey: 'contacts_column_website',
    icon: 'language',
    loadingRenderer: _streakyc_ui_components_table__WEBPACK_IMPORTED_MODULE_0__/* .LOADING_RENDERER */ .qS.name
  }
};
const CONTACTS_DEFAULT_PINNED_COLUMNS = ['name'];
const CONTACTS_COLUMNS_DEV_ONLY = ['familyName', 'givenName'];
const CONTACTS_CACHE_KEY_PATTERN = teamKey => `contacts_${teamKey}`;
const CONTACTS_SELECTED_TEAM_CACHE_KEY = 'streak_nav_team_key';
const CONTACTS_TEAM_PERMISSION_KEY = 'ALL_CONTACTS';
const CONTACTS_PERMISSION_ADMIN_KEY = '__adminPermissionSet__';
const CONTACTS_PERMISSION_FULL_ACCESS_KEY = '__editAllPermissionSet__';
const CONTACTS_PERMISSION_NO_ACCESS_KEY = '__emptyPermissionSet__';
const CONTACTS_AS_PAID_FEATURE_KEY = 'contactsOrgs';
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   k: () => (/* binding */ goToContactsView)
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(44345);
...
/* harmony import */ var _widgets_react_material_icon_icon__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(84347);
/* harmony import */ var _lib_dependencyManager__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(54612);
/* harmony import */ var _billing_helpers__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(87872);
/* harmony import */ var _core_enabledFeaturesController__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(50452);
/* harmony import */ var _widgets_spreadsheetV2__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(13222);
/* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(59386);
/* harmony import */ var _core_hooks_useSessionStorageValue__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(82513);
/* harmony import */ var _leftLink_navMenuController__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(47341);
...
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([_services_data_commonData__WEBPACK_IMPORTED_MODULE_6__, _billing_helpers__WEBPACK_IMPORTED_MODULE_9__, _core_enabledFeaturesController__WEBPACK_IMPORTED_MODULE_10__, _leftLink_navMenuController__WEBPACK_IMPORTED_MODULE_14__, _team__WEBPACK_IMPORTED_MODULE_16__, _widgets_paywallGateway_paywallGateway__WEBPACK_IMPORTED_MODULE_17__]);
([_services_data_commonData__WEBPACK_IMPORTED_MODULE_6__, _billing_helpers__WEBPACK_IMPORTED_MODULE_9__, _core_enabledFeaturesController__WEBPACK_IMPORTED_MODULE_10__, _leftLink_navMenuController__WEBPACK_IMPORTED_MODULE_14__, _team__WEBPACK_IMPORTED_MODULE_16__, _widgets_paywallGateway_paywallGateway__WEBPACK_IMPORTED_MODULE_17__] = __webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__);
...
const ContactsView = /*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_0__.lazy)(async () => {
  const {
    ContactsView
  } = await __webpack_require__.e(/* import() */ 7109).then(__webpack_require__.bind(__webpack_require__, 7109));
  return {
    default: ContactsView
  };
});
_lib_dependencyManager__WEBPACK_IMPORTED_MODULE_8__/* .DependencyManager */ .Lm.addFunction({
  dependentFunctionKeys: ['userPreServerExperiment', 'userLoggedIn', 'userSettingsInitialized', 'enabledFeaturesControllerInitialized', 'navMenuInitialized', 'data.teams.initialized'],
  functionKey: 'contactsRoutingInitialized',
  functionReference: async () => {
    const enabled = _core_enabledFeaturesController__WEBPACK_IMPORTED_MODULE_10__.EnabledFeatures.isFeatureEnabled('contactsViewExp') || _core_enabledFeaturesController__WEBPACK_IMPORTED_MODULE_10__.EnabledFeatures.isFeatureEnabled('contactsOrgsViewExp');
    if (!enabled) {
      return;
    }
    const teamsWithAccess = _services_data_commonData__WEBPACK_IMPORTED_MODULE_6__/* ["default"] */ .Z.getTeams().filter(t => (0,_team__WEBPACK_IMPORTED_MODULE_16__/* .isTeamBasedAccessAllowed */ .lf)(_constants__WEBPACK_IMPORTED_MODULE_12__/* .CONTACTS_TEAM_PERMISSION_KEY */ .O2, t, (0,_services_data_user__WEBPACK_IMPORTED_MODULE_19__/* .getUser */ .P)()));
    if (teamsWithAccess.length === 0) {
      return;
    }
    handleCustomRoute();
    if (_leftLink_navMenuController__WEBPACK_IMPORTED_MODULE_14__.navMenuController.streakPanelView) {
      _leftLink_navMenuController__WEBPACK_IMPORTED_MODULE_14__.navMenuController.streakPanelView.addNavItem({
        name: _services_locale_locale__WEBPACK_IMPORTED_MODULE_5__.Locale.getString('contacts'),
        iconClass: _leftLink_navMenuController_module_css__WEBPACK_IMPORTED_MODULE_20__/* .navItemIcon */ .U,
        iconLiga: 'perm_contact_calendar',
        routeID: _core_routing__WEBPACK_IMPORTED_MODULE_15__/* .StreakCustomRoute */ .ld.CONTACTS,
        onClick: e => {
          resetContactsViewScrollPosition();
          const contactsOrgsFeature = _core_enabledFeaturesController__WEBPACK_IMPORTED_MODULE_10__.EnabledFeatures.isFeatureEnabled(_constants__WEBPACK_IMPORTED_MODULE_12__/* .CONTACTS_AS_PAID_FEATURE_KEY */ .MJ);
          if (contactsOrgsFeature) {
            _core_gmail_inboxSdkSingleton__WEBPACK_IMPORTED_MODULE_4__.inboxSDK?.Router.goto(_core_routing__WEBPACK_IMPORTED_MODULE_15__/* .StreakCustomRoute */ .ld.CONTACTS);
          } else {
            e?.preventDefault();
            (0,_widgets_paywallGateway_paywallGateway__WEBPACK_IMPORTED_MODULE_17__/* ["default"] */ .Z)({
              feature: _constants__WEBPACK_IMPORTED_MODULE_12__/* .CONTACTS_AS_PAID_FEATURE_KEY */ .MJ
            });
          }
        },
    ...
    await _lib_dependencyManager__WEBPACK_IMPORTED_MODULE_8__/* .DependencyManager */ .Lm.whenAllFunctionsFinished(['data.teams.initialized']);

    // validate if session storage teamKey, if available, is valid
    // TODO: probably should be done outside contacts, because orgs view needs the same, but not need to run it twice
    const teamKey = (0,_core_hooks_useSessionStorageValue__WEBPACK_IMPORTED_MODULE_13__/* .LEGACY_HOOK_getSessionStorageValue */ .co)(_constants__WEBPACK_IMPORTED_MODULE_12__/* .CONTACTS_SELECTED_TEAM_CACHE_KEY */ .U6, undefined, {
      localStorageFallback: true
    });
    if (teamKey) {
      const team = teamsWithAccess.find(t => t.key() === teamKey);
      if (!team) {
        (0,_core_hooks_useSessionStorageValue__WEBPACK_IMPORTED_MODULE_13__/* .LEGACY_HOOK_setSessionStorageValue */ .uU)(_constants__WEBPACK_IMPORTED_MODULE_12__/* .CONTACTS_SELECTED_TEAM_CACHE_KEY */ .U6, undefined, {
          localStorageFallback: true
        });
      }
    }
...
async function setUpContactsNavItem() {
...
async function createNavItems() {
  const navItem = await setUpContactsNavItem();
  const teams = _services_data_commonData__WEBPACK_IMPORTED_MODULE_6__/* ["default"] */ .Z.getTeams().map(t => ({
    iconName: 'people_alt',
  ...
  teams.forEach(_ref => {
    ...
    (0,_core_appShell__WEBPACK_IMPORTED_MODULE_3__/* .renderWithAppShell */ .oC)(/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_18__.jsx)(_widgets_react_material_icon_icon__WEBPACK_IMPORTED_MODULE_7__/* ["default"] */ .Z, {
    ...
    const childNavItem = navItem?.addNavItem({
      iconElement,
      name,
      routeID: _core_routing__WEBPACK_IMPORTED_MODULE_15__/* .StreakCustomRoute */ .ld.CONTACTS_TEAM,
      routeParams: {
        key: teamKey
      },
      onClick() {
        (0,_widgets_spreadsheetV2__WEBPACK_IMPORTED_MODULE_11__/* .removeSpreadsheetCacheEntry */ .mH)((0,_constants__WEBPACK_IMPORTED_MODULE_12__/* .CONTACTS_CACHE_KEY_PATTERN */ .QR)(teamKey));
      }
    });
...
async function setUpAppMenuItem() {
  const mmAppMenu = _core_gmail_inboxSdkSingleton__WEBPACK_IMPORTED_MODULE_4__.inboxSDK.AppMenu.addMenuItem({
    name: _services_locale_locale__WEBPACK_IMPORTED_MODULE_5__.Locale.getString('contacts'),
    onClick: () => {
      if (!location.hash.startsWith('#streak_contacts')) {
        const teamKey = (0,_billing_helpers__WEBPACK_IMPORTED_MODULE_9__/* .getLargestTeam */ .n4)().key();
        (0,_widgets_spreadsheetV2__WEBPACK_IMPORTED_MODULE_11__/* .removeSpreadsheetCacheEntry */ .mH)((0,_constants__WEBPACK_IMPORTED_MODULE_12__/* .CONTACTS_CACHE_KEY_PATTERN */ .QR)(teamKey));
        _core_gmail_inboxSdkSingleton__WEBPACK_IMPORTED_MODULE_4__.inboxSDK?.Router.goto(_core_routing__WEBPACK_IMPORTED_MODULE_15__/* .StreakCustomRoute */ .ld.CONTACTS_TEAM, {
          key: teamKey
        });
      }
    },
    ...
    isRouteActive: routeView => {
      ...
      return routeViewID?.startsWith('streak_contacts') ?? false;
    }
  });
...
function handleCustomRoute() {
  ...
  _core_gmail_inboxSdkSingleton__WEBPACK_IMPORTED_MODULE_4__.inboxSDK.Router.handleCustomRoute(_core_routing__WEBPACK_IMPORTED_MODULE_15__/* .StreakCustomRoute */ .ld.CONTACTS_TEAM, customRouteView => {
    ...
    (0,_core_appShell__WEBPACK_IMPORTED_MODULE_3__/* .renderWithAppShell */ .oC)(/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_18__.jsx)(react__WEBPACK_IMPORTED_MODULE_0__.Suspense, {
      ...
      children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_18__.jsx)(_streakyc_ui_components_layout__WEBPACK_IMPORTED_MODULE_2__/* .LayoutBox */ .kZ, {
        ...
        minHeight: "100%",
        maxHeight: "100%",
        children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_18__.jsx)(ContactsView, {
          teamKey: teamKey,
  ...
  _core_gmail_inboxSdkSingleton__WEBPACK_IMPORTED_MODULE_4__.inboxSDK.Router.handleCustomRoute(_core_routing__WEBPACK_IMPORTED_MODULE_15__/* .StreakCustomRoute */ .ld.CONTACTS, customRouteView => {
    const teamsWithAccess = _services_data_commonData__WEBPACK_IMPORTED_MODULE_6__/* ["default"] */ .Z.getTeams().filter(t => (0,_team__WEBPACK_IMPORTED_MODULE_16__/* .isTeamBasedAccessAllowed */ .lf)(_constants__WEBPACK_IMPORTED_MODULE_12__/* .CONTACTS_TEAM_PERMISSION_KEY */ .O2, t, (0,_services_data_user__WEBPACK_IMPORTED_MODULE_19__/* .getUser */ .P)()));
    (0,_core_appShell__WEBPACK_IMPORTED_MODULE_3__/* .renderWithAppShell */ .oC)(/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_18__.jsx)(react__WEBPACK_IMPORTED_MODULE_0__.Suspense, {
      fallback: null,
      children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_18__.jsx)(_streakyc_ui_components_layout__WEBPACK_IMPORTED_MODULE_2__/* .LayoutBox */ .kZ, {
        ...
        minHeight: "100%",
        maxHeight: "100%",
        children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_18__.jsx)(_core_hooks_useSessionStorageValue__WEBPACK_IMPORTED_MODULE_13__/* .UseSessionStorageValue */ .Nu, {
          cacheKey: _constants__WEBPACK_IMPORTED_MODULE_12__/* .CONTACTS_SELECTED_TEAM_CACHE_KEY */ .U6,
          defaultValue: (0,_billing_helpers__WEBPACK_IMPORTED_MODULE_9__/* .getLargestTeam */ .n4)(teamsWithAccess)?.key(),
          options: {
            localStorageFallback: true
          },
          children: (teamKey, setTeamKey) => teamKey && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_18__.jsx)(ContactsView, {
            teamKey: teamKey,
            onTeamChange: teamKey => {
              resetContactsViewScrollPosition(teamKey);
              setTeamKey(teamKey);
            }
          }, teamKey)
        })
...
function goToContactsView(teamKey) {
  _core_gmail_inboxSdkSingleton__WEBPACK_IMPORTED_MODULE_4__.inboxSDK.Router.goto(_core_routing__WEBPACK_IMPORTED_MODULE_15__/* .StreakCustomRoute */ .ld.CONTACTS_TEAM, {
    key: teamKey
  });
}
function resetContactsViewScrollPosition(teamKey) {
  if (!teamKey) {
    teamKey = (0,_core_hooks_useSessionStorageValue__WEBPACK_IMPORTED_MODULE_13__/* .LEGACY_HOOK_getSessionStorageValue */ .co)(_constants__WEBPACK_IMPORTED_MODULE_12__/* .CONTACTS_SELECTED_TEAM_CACHE_KEY */ .U6, undefined, {
      localStorageFallback: true
    });
  }
  if (teamKey) {
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   goToContactsView: () => (/* reexport safe */ _internal_routing__WEBPACK_IMPORTED_MODULE_0__.k)
/* harmony export */ });
/* harmony import */ var _internal_routing__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(6372);
...
;
//# sourceMappingURL=https://storage.googleapis.com/streak-extension-sourcemaps/clientjs/clientjs.chunk.8109.403d0599bba2e91a0656.js.map